...
public class SocketController {
    ...
    public Future<List<MessageDto>> subscribeAsync(long sessionId) {
        return CompletableFuture.completedFuture(chatService.getLastMessages(50,sessionId));
    }


    @Async
    public Future<MessageDto> saveMessageAsync(MessageDto messageDto){
        return CompletableFuture.completedFuture(chatService.saveMessage(messageDto));
    }
}
