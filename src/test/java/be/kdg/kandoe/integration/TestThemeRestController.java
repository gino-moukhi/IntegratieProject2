...
public class TestThemeRestController {
    ...
    public void TestEditSubTheme(){
        ThemeDto dtoForSubThemes = restTemplate.getForEntity("http://localhost:9090/api/public/theme/"+theme2.getThemeId(),ThemeDto.class).getBody();
        ...
        ResponseEntity<SubThemeDto> response = restTemplate.exchange("http://localhost:9090/api/public/subtheme/"+subTheme1.getSubThemeId(),HttpMethod.PUT,httpEntity,SubThemeDto.class);
        ...
        Assert.assertThat(response.getBody().getTheme().getThemeId(),equalTo(theme2.getThemeId()));
    }
    ...
    private void setupDb(){
        ...
        ResponseEntity<SubThemeDto> response3 = restTemplate.postForEntity("http://localhost:9090/api/public/subthemes/"+theme1.getThemeId(),subTheme1,SubThemeDto.class);
        subTheme1=response3.getBody();
        ResponseEntity<SubThemeDto> response4= restTemplate.postForEntity("http://localhost:9090/api/public/subthemes/"+theme1.getThemeId(),subTheme2,SubThemeDto.class);
